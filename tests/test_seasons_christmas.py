...
class TestChristmasPromptGeneration:
    ...
    def test_prompt_has_style(self):
        ...
        season = Christmas()
        prompt = season.get_prompt()
        has_style = SeasonBase.STYLE_PREFIX in prompt or any(
            style in prompt for style in SeasonBase.ALTERNATE_STYLES
        )
